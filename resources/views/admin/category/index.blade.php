                ...
                <div class="col-12">
                    <div class="card my-4">
                        <div class=" me-3 my-3 d-flex justify-content-between align-items-center">
                            <h2 class="text-gradient text-dark mb-0 ms-3">Categories</h2>
                                    ...
                                    @foreach ($categories as $cat)
                                        <tr>
                                            ...
                                            <td class="align-middle text-center">
                                                <p class="text-xs text-secondary mb-0">{{ date_format($cat->created_at ,"d F Y H:i A") }}
                                                </p>
                                            </td>
                                            <td class="align-middle text-center">
                                                <p class="text-xs text-secondary mb-0">{{ date_format($cat->updated_at ,"d F Y H:i A") }}</p>
                                            </td>
                                            <td class="align-middle">
                                                <form action="{{ route('categories.destroy',$cat->id) }}" method="POST">
                                                   <a class="btn btn-secondary" href="{{ route('categories.edit',$cat->id) }}"><i class="material-icons">edit</i></a>
                                                   @csrf
                                                   @method('DELETE')
