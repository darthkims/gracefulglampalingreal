            ...
            <div class="row">
                <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset('customer')}}/img/product/product-15.jpg">
                        ...
                        <div class="product__item__text">
                            ...
                            <a href="{{ asset('customer')}}/img/product/product-15.jpg" class="add-cart">+ Add To Cart</a>
                            <div class="rating">
                                <i class="fa fa-star-o"></i>
                                <i class="fa fa-star-o"></i>
                                <i class="fa fa-star-o"></i>
