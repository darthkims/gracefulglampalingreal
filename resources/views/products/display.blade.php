                ...
                @foreach($randomIds as $randomId)
                    <div class="col-lg-3 col-md-6 col-sm-6 col-sm-6">
                        <div class="product__item">
                            <?php
                                $product = App\Models\Product::find($randomId);
                            ?>
                            <a href="{{ route('products.display', $product->id) }}"> <!-- Set your product details route -->
                                <div class="product__item__pic set-bg" data-setbg="{{ asset('customer/img/shop-details/thumb-1-' . $product->id . '.jpg') }}">
                                </div>
