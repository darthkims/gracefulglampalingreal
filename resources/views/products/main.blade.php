            ...
            <div class="row">
                <div class="col-lg-3 col-md-3">
                    <div class="header__logo">
                        <a href="./index.html"><img src="{{ asset('customer')}}/img/gg_full.png" alt=""></a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-lg-7 offset-lg-4">
                    <div class="banner__item">
                        <div class="banner__item__pic">
                            <img src="{{ asset('customer')}}/img/banner/banner-1.jpg" alt="">
                        </div>
                ...
                <div class="col-lg-5">
                    <div class="banner__item banner__item--middle">
                        <div class="banner__item__pic">
                            <img src="{{ asset('customer')}}/img/banner/banner-2.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
                            <h2>Accessories</h2>
                            <a href="#">Shop now</a>
                ...
                <div class="col-lg-7">
                    <div class="banner__item banner__item--last">
                        <div class="banner__item__pic">
                            <img src="{{ asset('customer')}}/img/banner/banner-3.jpg" alt="">
                        </div>
                        <div class="banner__item__text">
    ...
    <section class="product spad">
        <div class="container">
            ...
            <div class="row product__filter">
                    ...
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset('customer')}}/img/product/product-1.jpg">
                            ...
                            <ul class="product__hover">
                                ...
                                <li><a href="#"><img src="{{ asset('customer')}}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                ...
                <div class="col-lg-3 col-md-6 col-sm-6 col-md-6 col-sm-6 mix new-arrivals">
                    <div class="product__item">
                        <div class="product__item__pic set-bg" data-setbg="{{ asset('customer')}}/img/product/product-5.jpg">
                            <ul class="product__hover">
                                <li><a href="#"><img src="{{ asset('customer')}}/img/icon/heart.png" alt=""></a></li>
                                <li><a href="#"><img src="{{ asset('customer')}}/img/icon/compare.png" alt=""> <span>Compare</span></a></li>
                                <li><a href="#"><img src="{{ asset('customer')}}/img/icon/search.png" alt=""></a></li>
    ...
    <section class="latest spad">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6 col-sm-6">
                    <div class="blog__item">
                        <div class="blog__item__pic set-bg" data-setbg="{{ asset('customer')}}/img/blog/blog-3.jpg"></div>
                        <div class="blog__item__text">
