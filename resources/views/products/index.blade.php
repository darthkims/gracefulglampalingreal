                                    ...
                                    <tr>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div class="d-flex flex-column justify-content-center">
                                                        <p class="mb-0 text-sm">{{ $product->product_ID }}</p>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>
                                                <div class="d-flex px-2 py-1">
                                                    <div>
                                                        <img src="{{ asset('customer/img/product/product-' . $product-> product_ID . '.jpg') }}"
                                            ...
                                            <form action="{{ route('products.destroy',$product->product_ID) }}" method="POST">
                                                <a rel="tooltip" class="btn btn-success btn-link"
                                                    href="{{ route('products.edit',$product->product_ID) }}" data-original-title=""
                                                    title="">
